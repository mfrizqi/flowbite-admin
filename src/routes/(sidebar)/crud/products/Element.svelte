...
<Heading tag="h5" class="mb-6 text-sm font-semibold uppercase">Add new element</Heading>
<CloseButton
...
<form action="#">
	<div class="space-y-4">
		...
		<Label class="space-y-2">
			<span>Symbol</span>
			<Input name="symblo" class="border font-normal outline-none" placeholder="H" required />
		</Label>
		<Label class="space-y-2">
			<span>Atomic Number</span>
			<Input name="atomic-number" class="border font-normal outline-none" placeholder="1" type="number" required />
		</Label>
		<Label class="space-y-2">
			<span>Units</span>
			<Input name="atomic-number" class="border font-normal outline-none" placeholder="1" type="number" required />
		...
		<div class="bottom-0 left-0 flex w-full justify-center space-x-4 pb-4 md:absolute md:px-4">
			<Button type="submit" class="w-full">Add Element</Button>
